...
pipe = joblib.load(open(r'C:\Users\admin\Desktop\ipl_win_predictions\pickle\joblibpipe.pkl','rb'))
...
if st.button('Predict Probability'):
    ...
    # Assuming `pipe` is a classification model
    # result = loaded_model.predict_proba(your_data)
